...
function ChartColorChangeSparkLine(r, o, a) {
    ...
    r.prototype.createAreaChart = function(e, r, o, a, t, n, i, l) {
        ...
        e && this.createAreaChart("morris-area-example", 0, 0, [{
            y: "2011",
            a: 0,
            b: 0,
            c: 0
            ...
            b: 30,
            c: 30
        }], "y", ["a", "b", "c"], ["Series A", "Series B", "Series C"], e);
        var r = getChartColorsArray("morris-donut-example");
        r && this.createDonutChart("morris-donut-example", [{
        ...
        o && this.createStackedChart("morris-bar-stacked", [{
            y: "2005",
            a: 45,
            b: 180
        }, {
...
var series, chartoption, demo, sparklineChart1Colors = getChartColorsArray("sparkline");
sparklineChart1Colors && (series = [8, 6, 4, 7, 10, 12, 7, 4, 9, 12, 13, 11, 12], chartoption = {
    type: "bar",
    height: "130",
    barWidth: "10",
    barSpacing: "7",
    barColor: "#7A6FBE"
}, demo = $("#sparkline").sparkline(series, chartoption), ChartColorChangeSparkLine(series, chartoption, "sparkline"));