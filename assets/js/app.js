function getChartColorsArray(e) {
    if (null !== document.getElementById(e)) {
        ...
        if (t) return (t = JSON.parse(t)).map(function(e) {
            ...
            var n = e.split(",");
            return 2 != n.length ? t : "rgba(" + getComputedStyle(document.documentElement).getPropertyValue(n[0]) + "," + n[1] + ")"
        });
        console.warn("data-colors Attribute not found on:", e)
    }
}

function ChartColorChangeSparkLine(t, a, n) {
    document.querySelectorAll(".theme-color").forEach(function(e) {
        e.addEventListener("click", function(e) {
            setTimeout(function() {
                var e = getChartColorsArray(n);
                a.barColor = e, $("#" + n).sparkline(t, a)
            }, 0)
        })
    })
}! function(r) {
    ...
    function t(e) {
        1 == r("#light-mode-switch").prop("checked") && "light-mode-switch" === e ? (r("html").removeAttr("dir"), r("#dark-mode-switch").prop("checked", !1), r("#rtl-mode-switch").prop("checked", !1), r("#bootstrap-style").attr("href", "assets/css/bootstrap.min.css"), r("#app-style").attr("href", "assets/css/app.min.css"), sessionStorage.setItem("is_visited", "light-mode-switch")) : 1 == r("#dark-mode-switch").prop("checked") && "dark-mode-switch" === e ? (r("html").removeAttr("dir"), r("#light-mode-switch").prop("checked", !1), r("#rtl-mode-switch").prop("checked", !1), r("#bootstrap-style").attr("href", "assets/css/bootstrap-dark.min.css"), r("#app-style").attr("href", "assets/css/app-dark.min.css"), sessionStorage.setItem("is_visited", "dark-mode-switch")) : 1 == r("#rtl-mode-switch").prop("checked") && "rtl-mode-switch" === e && (r("#light-mode-switch").prop("checked", !1), r("#dark-mode-switch").prop("checked", !1), r("#bootstrap-style").attr("href", "assets/css/bootstrap-rtl.min.css"), r("#app-style").attr("href", "assets/css/app-rtl.min.css"), r("html").attr("dir", "rtl"), sessionStorage.setItem("is_visited", "rtl-mode-switch"))
    }
    ...
    r("#side-menu").metisMenu(), r(".vertical-menu-btn").on("click", function(e) {
            ...
            var e;
            0 < r("#sidebar-menu").length && 0 < r("#sidebar-menu .mm-active .active").length && (300 < (e = r("#sidebar-menu .mm-active .active").offset().top) && (e -= 300, r(".simplebar-content-wrapper").animate({
                scrollTop: e
            }, "slow")))
        ...
        function() {
            ...
            var a = r(this).attr("data-delay") ? r(this).attr("data-delay") : 100,
                n = r(this).attr("data-time") ? r(this).attr("data-time") : 1200;
        ...
        }(), window.sessionStorage && ((a = sessionStorage.getItem("is_visited")) ? (r(".right-bar input:checkbox").prop("checked", !1), r("#" + a).prop("checked", !0), t(a)) : sessionStorage.setItem("is_visited", "light-mode-switch")), r("#light-mode-switch, #dark-mode-switch, #rtl-mode-switch").on("change", function(e) {
            t(e.target.id)
        }),
        function() {
            var e = getChartColorsArray("header-chart-1");
            e && (t = [8, 6, 4, 7, 10, 12, 7, 4, 9, 12, 13, 11, 12], a = {
                type: "bar",
                height: "32",
                barWidth: "5",
                barSpacing: "3",
                barColor: e
            }, r("#header-chart-1").sparkline(t, a), ChartColorChangeSparkLine(t, a, "header-chart-1"));
            var t, a, n = getChartColorsArray("header-chart-2");
            n && (t = [8, 6, 4, 7, 10, 12, 7, 4, 9, 12, 13, 11, 12], a = {
                type: "bar",
                height: "32",
                barWidth: "5",
                barSpacing: "3",
                barColor: n
            }, r("#header-chart-2").sparkline(t, a), ChartColorChangeSparkLine(t, a, "header-chart-2"))
