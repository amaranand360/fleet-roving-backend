...
function _arrayLikeToArray(e, t) {
    ...
    e(), n = ".card", o(document).on("click", '.card a[data-bs-toggle="remove"]', function(e) {
    ...
    }), t(), o(".topnav-menu").length && (o(".topnav-menu li a").each(function() {
        var e = window.location.href.split(/[?#]/)[0];
        ...
        var n = o.extend({}, s, o(t).data());
        o(t).timepicker(n)
    })), jQuery().TouchSpin && (s = {}, o('[data-toggle="touchspin"]').each(function(e, t) {
        var n = o.extend({}, s, o(t).data());
        o(t).TouchSpin(n)
    })), jQuery().maxlength && (s = {
...
var ThemeCustomizer = function() {
    ...
    return _createClass(e, [{
        ...
        key: "resetTheme",
        value: function() {
            this.config = JSON.parse(JSON.stringify(window.defaultConfig)), this.changeLeftbarColor(this.config.sidenav.color), this.changeLeftbarSize(this.config.sidenav.size), this.changeLayoutColor(this.config.theme), this.changeLayoutMode(this.config.layout.mode), this.changeLayoutPosition(this.config.layout.position), this.changeTopbarColor(this.config.topbar.color), this.changeSidebarUser(this.config.sidenav.user), this._adjustLayout()
        }
    }, {
